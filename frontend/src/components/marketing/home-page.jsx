...
export function HomePage() {
  ...
  const primaryHref = !bootstrapping && isAuthenticated ? "/dashboard" : "/register";
  const primaryLabel =
    !bootstrapping && isAuthenticated ? "Open workspace" : "Get Started Free";
        ...
        <section className="px-4 pb-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl rounded-3xl bg-[linear-gradient(135deg,#0058be_0%,#2170e4_55%,#316bf3_100%)] px-6 py-14 text-center text-on-primary sm:px-10">
            <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">
              Ready to run content like a system?
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-on-primary/85 sm:text-base">
              Create your creatoros workspace and start with authentication-ready foundations built
              for the full product loop.
            </p>
